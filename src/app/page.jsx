      ...
      <section className="hero" id="home">
        ...
        <div className="container hero-container">
          <div className="hero-content fade-up">
            ...
            <h1>
              <span style={{ display: 'inline-block', animation: 'heroTitleFadeUp 1s cubic-bezier(0.165, 0.84, 0.44, 1) 0.1s forwards', opacity: 0 }}>Transformamos datos en</span> <br />
              <span style={{ display: 'inline-block', animation: 'heroTitleFadeUp 1s cubic-bezier(0.165, 0.84, 0.44, 1) 0.3s forwards', opacity: 0 }}><span>decisiones inteligentes</span></span>
            </h1>
            ...
            <div className="nosotros-philosophy">
              ...
              <div className="philosophy-valores">
                ...
                <div className="valores-mini-grid">
                  <div className="v-mini-item reveal fade-up delay-100"><i data-lucide="shield-check"></i><span>Honestidad</span></div>
                  <div className="v-mini-item reveal fade-up delay-200"><i data-lucide="lightbulb"></i><span>Innovación</span></div>
                  <div className="v-mini-item reveal fade-up delay-300"><i data-lucide="award"></i><span>Calidad</span></div>
                  <div className="v-mini-item reveal fade-up delay-400"><i data-lucide="heart"></i><span>Compromiso</span></div>
                  <div className="v-mini-item reveal fade-up delay-500"><i data-lucide="headphones"></i><span>Servicio</span></div>
                  <div className="v-mini-item reveal fade-up delay-600"><i data-lucide="trending-up"></i><span>Responsabilidad</span></div>
                </div>
              </div>
